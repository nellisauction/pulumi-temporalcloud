module github.com/nellisauction/pulumi-temporalcloud/provider
...
require (
	...
	github.com/temporalio/terraform-provider-temporalcloud/shim v0.0.0
)
...
require (
	...
	github.com/temporalio/terraform-provider-temporalcloud v1.3.0 // indirect
